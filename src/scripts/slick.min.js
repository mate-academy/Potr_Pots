!(function(i) {
  'use strict'; typeof define === 'function' && define.amd ? define(['jquery'], i) : typeof exports !== 'undefined' ? module.exports = i(require('jquery')) : i(jQuery);
}(function(i) {
  'use strict';
  ...
  (e = (function() {
    ...
    const e = this; let t = e.options.asNavFor;
    ...
    const i = this; let e = i.currentSlide + i.options.slidesToScroll;
    ...
    let i; let e; let t; let o; let s; let n; let r; const l = this;
    ...
    let o; let s; let n; const r = this; let l = !1; const d = r.$slider.width(); const a = window.innerWidth || i(window).width();
    ...
    const i = this; let e = 0; let t = 0; let o = 0;
    ...
    let e; let t; let o; let s; const n = this; let r = 0;
    ...
    let i; const e = this; let t = 0; let o = 0; const s = [];
    ...
    const e = this; const t = Math.ceil(e.slideCount / e.options.slidesToShow); const o = e.getNavigableIndexes().filter(function(i) {
      return i >= 0 && i < e.slideCount;
    });

    e.$slides.add(e.$slideTrack.find('.slick-cloned')).attr({ 'aria-hidden': 'true', tabindex: '-1' }).find('a, input, button, select').attr({ tabindex: '-1' }), e.$dots !== null && (e.$slides.not(e.$slideTrack.find('.slick-cloned')).each(function(t) {
      const s = o.indexOf(t);

      i(this).attr({ role: 'tabpanel', id: 'slick-slide' + e.instanceUid + t, tabindex: -1 }), s !== -1 && i(this).attr({ 'aria-describedby': 'slick-slide-control' + e.instanceUid + s });
    ...
    i.target.tagName.match('TEXTAREA|INPUT|SELECT') || (i.keyCode === 37 && !0 === e.options.accessibility ? e.changeSlide({ data: { message: !0 === e.options.rtl ? 'next' : 'previous' } }) : i.keyCode === 39 && !0 === e.options.accessibility && e.changeSlide({ data: { message: !0 === e.options.rtl ? 'previous' : 'next' } }));
  }, e.prototype.lazyLoad = function() {
    function e(e) {
      i('img[data-lazy]', e).each(function() {
        const e = i(this); const t = i(this).attr('data-lazy'); const o = i(this).attr('data-srcset'); const s = i(this).attr('data-sizes') || n.$slider.attr('data-sizes'); const r = document.createElement('img');
    ...
    let t; let o; let s; var n = this;

    if (!0 === n.options.centerMode ? !0 === n.options.infinite ? s = (o = n.currentSlide + (n.options.slidesToShow / 2 + 1)) + n.options.slidesToShow + 2 : (o = Math.max(0, n.currentSlide - (n.options.slidesToShow / 2 + 1)), s = n.options.slidesToShow / 2 + 1 + 2 + n.currentSlide) : (o = n.options.infinite ? n.options.slidesToShow + n.currentSlide : n.currentSlide, s = Math.ceil(o + n.options.slidesToShow), !0 === n.options.fade && (o > 0 && o--, s <= n.slideCount && s++)), t = n.$slider.find('.slick-slide').slice(o, s), n.options.lazyLoad === 'anticipated') {
    ...
    let t; let o; let s; let n; let r; const l = this; const d = i('img[data-lazy]', l.$slider);
    ...
    let t; let o; const s = this;

    o = s.slideCount - s.options.slidesToShow, !s.options.infinite && s.currentSlide > o && (s.currentSlide = o), s.slideCount <= s.options.slidesToShow && (s.currentSlide = 0), t = s.currentSlide, s.destroy(!0), i.extend(s, s.initials, { currentSlide: t }), s.init(), e || s.changeSlide({ data: { message: 'index', index: t } }, !1);
  }, e.prototype.registerBreakpoints = function() {
    let e; let t; let o; const s = this; const n = s.options.responsive || null;
    ...
    if (i = typeof i === 'boolean' ? !0 === (e = i) ? 0 : o.slideCount - 1 : !0 === e ? --i : i, o.slideCount < 1 || i < 0 || i > o.slideCount - 1) {
      return !1;
    } o.unload(), !0 === t ? o.$slideTrack.children().remove() : o.$slideTrack.children(this.options.slide).eq(i).remove(), o.$slides = o.$slideTrack.children(this.options.slide), o.$slideTrack.children(this.options.slide).detach(), o.$slideTrack.append(o.$slides), o.$slidesCache = o.$slides, o.reinit();
  }, e.prototype.setCSS = function(i) {
    let e; let t; const o = this; let s = {};
    ...
    let e; let t; let o; let s; let n; const r = this; let l = !1;

    if (i.type(arguments[0]) === 'object' ? (o = arguments[0], l = arguments[1], n = 'multiple') : i.type(arguments[0]) === 'string' && (o = arguments[0], s = arguments[1], l = arguments[2], arguments[0] === 'responsive' && i.type(arguments[1]) === 'array' ? n = 'responsive' : void 0 !== arguments[1] && (n = 'single')), n === 'single') {
      r.options[o] = s;
    } else if (n === 'multiple') {
    ...
    const i = this; const e = document.body.style;
    ...
    let e; let t; let o; let s; const n = this;
    ...
    let e; let t; let o; const s = this;
    ...
    const t = this; const o = i(e.target).is('.slick-slide') ? i(e.target) : i(e.target).parents('.slick-slide'); let s = parseInt(o.attr('data-slick-index'));

    s || (s = 0), t.slideCount <= t.options.slidesToShow ? t.slideHandler(s, !1, !0) : t.slideHandler(s);
  }, e.prototype.slideHandler = function(i, e, t) {
    let o; let s; let n; let r; let l; let d = null; const a = this;

    if (e = e || !1, !(!0 === a.animating && !0 === a.options.waitForAnimate || !0 === a.options.fade && a.currentSlide === i)) {
      if (!1 === e && a.asNavFor(i), o = i, d = a.getLeft(o), r = a.getLeft(a.currentSlide), a.currentLeft = a.swipeLeft === null ? r : a.swipeLeft, !1 === a.options.infinite && !1 === a.options.centerMode && (i < 0 || i > a.getDotCount() * a.options.slidesToScroll)) {
    ...
    let i; let e; let t; let o; const s = this;
    ...
    if (!(!1 === e.options.swipe || 'ontouchend' in document && !1 === e.options.swipe || !1 === e.options.draggable && i.type.indexOf('mouse') !== -1)) {
    ...
    let e; let t; let o; let s; let n; let r; const l = this;
    ...
    if (t.interrupted = !0, t.touchObject.fingerCount !== 1 || t.slideCount <= t.options.slidesToShow) {
    ...
    let i; let t; const o = this; const s = arguments[0]; const n = Array.prototype.slice.call(arguments, 1); const r = o.length;

    for (i = 0; i < r; i++) {
      if (typeof s === 'object' || void 0 === s ? o[i].slick = new e(o[i], s) : t = o[i].slick[s].apply(o[i].slick, n), void 0 !== t) {
        return t;
      }
    }
